...
//                'only' => ['logout'],
    ...
    public function actionIndex()
    {
        if(Yii::$app->user->isGuest){
            ...
            return $this->redirect(['/user/tasks/'.Yii::$app->user->id]);
        }
    }
    ...
    public function actionInvite()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->invite()) {
            Yii::$app->session->setFlash('success', 'User has been invited. Please ask them to check their inbox for a verification email!');
            return $this->goHome();
        }
    ...
    public function actionVerifyEmail($token)
    {
        ...
        if (($user = $model->verifyEmail()) && Yii::$app->user->login($user)) {
            ...
            $user->save();
            return $this->actionResetPassword($user->password_reset_token);
